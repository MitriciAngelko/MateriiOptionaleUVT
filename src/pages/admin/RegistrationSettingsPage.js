      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-3 text-lg">
            Configurează perioadele și setările pentru înregistrarea studenților
          </p>
        </div>

        {error && (
          <div className="mb-4 p-3 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded border border-red-200 dark:border-red-700">
            {error}
          </div>
        )}

        {successMessage && (
          <div className="mb-4 p-3 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded border border-green-200 dark:border-green-700">
            {successMessage}
          </div>
        )}

        <div className="bg-white/80 backdrop-blur-sm dark:bg-gray-800/50 rounded-lg shadow-md p-6 mb-6 border border-gray-200 dark:border-gray-700">
          <h2 className="text-xl font-semibold text-[#034a76] dark:text-blue-light mb-4">Perioada de înscriere</h2>
