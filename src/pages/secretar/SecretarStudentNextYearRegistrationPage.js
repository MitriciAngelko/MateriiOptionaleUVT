...
const SecretarStudentNextYearRegistrationPage = () => {
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredStudents.map((student, index) => (
                  <tr 
                    key={student.id}
                    className={`hover:bg-gradient-to-r hover:from-[#3471B8]/5 hover:to-[#E3AB23]/5 transition-all duration-200 border-l-4 ${
                      selectedStudents.includes(student.id) 
                        ? 'bg-gradient-to-r from-[#3471B8]/10 to-[#E3AB23]/10 border-[#E3AB23]' 
                        : index % 2 === 0 ? 'bg-gray-50/30 border-transparent' : 'bg-white border-transparent'
                    }`}
                  >
                    <td className="px-6 py-4 whitespace-nowrap">
                      <input
                        ...
                        className="w-4 h-4 text-[#024A76] border-gray-300 rounded focus:ring-[#024A76] focus:ring-2"
                      />
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-semibold text-[#024A76]">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-[#024A76] text-white">
                        Anul {student.an}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-[#3471B8] to-[#024A76] text-white">
                        {student.currentECTS} ECTS
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-[#E3AB23] text-[#024A76]">
...
export default SecretarStudentNextYearRegistrationPage; 